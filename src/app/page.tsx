...
const testimonials = [
  ...
  { name: 'Sofia T.', uni: 'Bristol', text: 'I was dreading house hunting. UniDwell made it actually fun.', score: 91 },
]
    ...
    <main className="min-h-screen bg-white overflow-hidden">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-md border-b border-brand-100">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <span className="text-xl font-bold gradient-text">UniDwell</span>
      ...
      <section className="relative pt-32 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            UniDwell matches verified students based on lifestyle, budget, and vibe.
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gradient-brand rounded-3xl p-10 shadow-glow">
            ...
            <p className="text-brand-200 mb-8">
              Join thousands of students already matching on UniDwell.
            </p>
      ...
      <footer className="py-8 px-4 border-t border-slate-100 text-center">
        <p className="text-sm text-slate-400">
          © 2025 UniDwell · Student-only roommate matching
        </p>
      </footer>
    </main>
  )
